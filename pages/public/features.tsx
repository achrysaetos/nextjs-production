            ...
            <div className="lg:pr-4">
              <div className="lg:max-w-lg">
                ...
                <p className="mt-6 text-xl leading-8 text-gray-700">
                  For the first time, you'll have access to a fully customizable ChatGPT assistant, minus the exorbitant fees of other providers. Don't pay more than you have to.
                </p>
              </div>
            </div>
          </div>
                ...
                <ul role="list" className="space-y-8 text-gray-600">
                  <li className="flex gap-x-3">
                    ...
                    <span>
                      ...
                      {" "} Your official ChatGPT key from OpenAI offers unparalleled flexibility for your use case. Per-message rates only apply for the messages you send, so you only pay for what you use.
                    </span>
                  </li>
                  <li className="flex gap-x-3">
